...
export type GetProfileUserByIdQuery = {
    __typename?: 'Query';
    getProfileUserById?: {
        __typename?: 'Profile';
        id: number;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        ...
        updateProfileUser(
            variables: UpdateProfileUserMutationVariables,
            requestHeaders?: Dom.RequestInit['headers'],
        ): Promise<UpdateProfileUserMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<UpdateProfileUserMutation>(UpdateProfileUserDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                'updateProfileUser',
        ...
        getProfileUserById(
            variables: GetProfileUserByIdQueryVariables,
            requestHeaders?: Dom.RequestInit['headers'],
        ): Promise<GetProfileUserByIdQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetProfileUserByIdQuery>(GetProfileUserByIdDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                'getProfileUserById',
